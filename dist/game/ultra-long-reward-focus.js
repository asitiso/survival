export function compactUltraLongBossRewards(choices, context) {
    ...
    if (elapsed < 7200 || !complete)
        return { choices: choices.map(choice => ({ ...choice })), compact: false, subtitle: '유물 1개 또는 보스 성장 2개 중 선택', autoSelect: false, estimatedDecisionReduction: 0 };
