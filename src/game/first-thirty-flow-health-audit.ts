...
const baseEquipment:EquipmentState={coins:1800,weapon:{id:'arcane-staff',kind:'weapon',name:'Arcane',rank:2,power:.15,legendary:false},armor:{id:'iron-robe',kind:'armor',name:'Robe',rank:2,power:.08,legendary:false},healingPotions:2,inventory:[],discoveredRecipes:[]};
