...
export function dashPatternReleasePresentation(input, reducedMotion = false, reducedFlash = false) {
    ...
    return { reacquire: settled, dashGapScale: 1 + unsettled * range * accessibility, presentationOnly: true };
}
