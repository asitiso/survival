    ...
    drawBossArenaHazards(ctx, motion) {
        ...
        if (safeLane) {
            ...
            for (const feather of safeLaneGapFeather.featherSegments) {
                ctx.globalAlpha = safeLaneBaseAlpha * safeLaneHazardRecovery.pathAlphaScale * feather.alphaScale * safeLaneFinalSettle.secondaryScale * safeLaneFinalSettleBudget.secondaryScale;
                ctx.beginPath();
            ...
            if (safeLaneGapFeather.locatorVisible) {
                ctx.globalAlpha = safeLaneBaseAlpha * safeLaneHazardOcclusion.locatorAlphaScale * safeLaneHazardRecovery.locatorAlphaScale * safeLaneFinalSettle.secondaryScale * safeLaneFinalSettleBudget.secondaryScale;
                ctx.beginPath();
