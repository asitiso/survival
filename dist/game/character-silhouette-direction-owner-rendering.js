...
export function characterSilhouetteDirectionOwnerPresentation(input, reducedMotion = false) {
    ...
    let owner = 'locomotion', facing = locomotion;
    if (hit > .22) {
        owner = 'hit';
        facing = hitDirection;
    }
    else if (input.kind === 'boss' && special > .24) {
        owner = 'special';
        facing = target;
    }
    else if (attack > .18) {
