...
export const FINAL_FORM_PATTERN_IDS = new Set(Object.keys(PATTERNS));
export function finalFormAttackPattern(formId) {
    return FINAL_FORM_PATTERN_IDS.has(formId) ? PATTERNS[formId] : null;
}
