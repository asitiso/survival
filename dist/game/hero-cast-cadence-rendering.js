...
export function advanceHeroCastCadenceState(previous, castTriggered, dt, reducedMotion = false) {
...
export function heroCastCadencePresentation(state, cast, recover, speed, reducedMotion = false) {
