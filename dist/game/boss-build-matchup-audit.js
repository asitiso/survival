import { bossArchetypeForOrdinal, bossArchetypeSpecial, bossArchetypeTuning } from './boss-patterns.js';
...
function matchupModifier(sample, boss) {
...
export function bossBuildMatchupSamples() {
...
export function auditBossBuildMatchups() {
