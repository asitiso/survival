export const ASCENSION_MUTATOR_IDENTITY_IDS = ['accelerated_projectiles', 'reinforced_elites', 'volatile_death', 'scarce_shop'];
...
export function ascensionMutatorIdentityIcon(id) {
...
export function auditAscensionMutatorIdentityAtlas() {
    const cells = new Set();
    const outOfBounds = [];
