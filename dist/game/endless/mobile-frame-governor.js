...
export function createDefaultMobileFrameGovernorState() {
...
export function advanceMobileFrameGovernor(state, sample) {
...
export function mobileFrameGovernorPolicy(tier) {
    if (tier === 'minimal')
        return { visualDensity: .48, projectileVisualDensity: .42, maxQuality: 'low', particleCap: 64, trailCap: 28, telegraphCap: 24 };
    if (tier === 'reduced')
        return { visualDensity: .72, projectileVisualDensity: .68, maxQuality: 'medium', particleCap: 112, trailCap: 48, telegraphCap: 24 };
