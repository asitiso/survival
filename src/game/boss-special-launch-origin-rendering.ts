...
export interface BossSpecialLaunchOriginInput{archetype:BossArchetype;phase:BossPhase;radius:number;facingX:number;facingY:number;specialTimer:number;rebaseOffsetX:number;rebaseOffsetY:number;handoffStrength:number;recovery?:number;stagger?:number}
