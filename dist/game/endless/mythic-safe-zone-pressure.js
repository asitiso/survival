...
export function mythicSafeZonePressure(archetype, zone, destroyedWeakpointRatio) {
    if (!zone)
        return { specialCadenceMultiplier: 1, summonCountMultiplier: 1, dashDistanceMultiplier: 1, bossDamageTakenMultiplier: 1 };
