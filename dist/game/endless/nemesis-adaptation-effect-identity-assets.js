export const NEMESIS_ADAPTATION_EFFECT_IDENTITY_IDS = ['damage-resistance', 'dash-distance', 'summon-pressure', 'special-cadence', 'mirror-affinity'];
...
export function nemesisAdaptationEffectIdentityIcon(id) {
...
export function auditNemesisAdaptationEffectIdentityAtlas() {
