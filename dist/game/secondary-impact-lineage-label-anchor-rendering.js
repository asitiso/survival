...
export function secondaryImpactLineageLabelPresentation(input, reducedFlash = false) {
    ...
    return { visible, text: visible ? `×${heldCount}` : '', pos, alpha: visible ? baseAlpha * (reducedFlash ? .62 : 1) : 0, lineageKey: input.lineageKey, heldCount, presentationOnly: true };
}
