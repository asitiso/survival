...
export function lastLawSafeZoneLifecycle(active, destroyedWeakpointRatio) {
    if (!active)
        return { active: false, cycleMs: 9000, stableEndMs: 4800, collapseEndMs: 6200, collapsedEndMs: 7800, reformEndMs: 9000, radiusMultiplier: 1 };
