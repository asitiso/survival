...
const defaultMotion = { motionBlend: 0, stride: 0, facingX: 1, facingY: 0, turn: 0, recovery: 0 };
const defaultSignature = { arrival: 0, brace: 0, plant: 0 };
export function specialistTurnStopPresentation(type, motion, signature, reducedMotion = false) {
