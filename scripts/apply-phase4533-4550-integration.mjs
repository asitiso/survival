...
replaceOnce(
  'active affix lifecycle rendering',
...
replaceOnce(
  'Frenzied arbitration rendering',
...
replaceOnce(
  'Swift response connector scale',
  "ctx.save();ctx.globalAlpha=ownership.connectorAlpha*t;",
  "ctx.save();ctx.globalAlpha=ownership.connectorAlpha*t*responseLayer.responseAlphaScale;",
);
...
console.log('Applied Phase 4533-4550 EnemyManager integration.');
