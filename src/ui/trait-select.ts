import { MASTERY_RUN_TRAITS, RUN_TRAITS, type RunTrait, type RunTraitId } from '../game/run-traits.js';
...
export function traitChoiceCards(heroId?: HeroId, masteryLevel = 1): readonly RunTrait[] {
  if (!heroId || masteryLevel < 6) return RUN_TRAITS;
...
export class TraitSelectOverlay {
  ...
  open(heroId: HeroId, onSelect: (id: RunTraitId) => void, masteryLevel = 1): void {
    this.isOpen = true;
