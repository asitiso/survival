...
export function spawnLaneEdgeLabelFade(input) {
    ...
    if (input.count <= 1 || ttl <= 0 || alpha <= 0)
        return { visible: false, labelAlpha: 0, presentationOnly: true, gameplayMutation: false };
