...
import type { FinalFormEvadeFinisherProfile, FinalFormEvadeFinisherFamily } from './final-form-evade-finisher.js';

export interface FinalFormFinisherFeedback {
...
const SOUND:Record<Exclude<FinalFormEvadeFinisherFamily,'base'>,SoundKind>={
...
export function finalFormFinisherFeedback(_formId:HeroFinalFormId|null,finisher:FinalFormEvadeFinisherProfile):FinalFormFinisherFeedback{
  const family=finisher.family;
  if(family==='base')return{family,accent:finisher.accent,soundKind:'flowImpact',particleCount:6,ringCount:1,trailCount:0,ttl:.22,shake:2.6,particleSpeed:74,ringStep:18};
