...
import { hazardThreatRhythmPresentation, safeLaneThreatRhythmPresentation, threatRhythmBudgetPresentation } from './threat-impact-rhythm-stagger-rendering.js';
import { hazardThreatRhythmRecoveryPresentation, safeLaneThreatRhythmRecoveryPresentation, threatRhythmRecoveryBudgetPresentation } from './threat-impact-rhythm-recovery-rendering.js';
import { denseHazardThreatRhythmPresentation, denseSafeLaneThreatRhythmPresentation, denseThreatRhythmBudgetPresentation } from './threat-impact-dense-rhythm-rendering.js';
    ...
    drawBossArenaHazards(ctx, motion) {
        ...
        if (safeLane) {
            ...
            for (const feather of safeLaneGapFeather.featherSegments) {
                ctx.globalAlpha = safeLaneBaseAlpha * safeLaneHazardRecovery.pathAlphaScale * feather.alphaScale * safeLaneFinalSettle.secondaryScale * safeLaneFinalSettleBudget.secondaryScale * safeLaneSecondaryRecoveryGate.secondaryScale * safeLaneSecondaryRecoveryGateBudget.secondaryScale * safeLaneFocusTransfer.secondaryScale * safeLaneFocusTransferBudget.secondaryScale * safeLaneRhythm.secondaryScale * safeLaneRhythmBudget.secondaryScale * safeLaneRhythmRecovery.secondaryScale * safeLaneRhythmRecoveryBudget.secondaryScale * safeLaneDenseRhythm.secondaryScale * safeLaneDenseRhythmBudget.secondaryScale;
                ctx.beginPath();
