...
("insert_after('src/game/enemies.ts','const hasBossVisual = Boolean(projectile.bossArchetype',\"      const projectileEffectiveFloor=", "insert_after('src/game/enemies.ts','const projectileCriticalReengagement=',\"      const projectileEffectiveFloor="),
("bossVisual:hasBossVisual", "bossVisual:Boolean(projectile.bossArchetype&&bossSpecialVfxAtlasReady&&bossSpecialVfxAtlasImage)"),
