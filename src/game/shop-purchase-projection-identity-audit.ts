...
const SCENARIOS:readonly {id:string;state:EquipmentState}[]=[
  ...
  {id:'upgrade',state:{coins:2000,weapon:item('arcane-staff','weapon',2,.15),armor:item('iron-robe','armor',2,.08),healingPotions:1,inventory:[],discoveredRecipes:[]}},
  {id:'legendary',state:{coins:2000,weapon:item('arcane-staff','weapon',4,.15),armor:item('iron-robe','armor',4,.08),healingPotions:2,inventory:[],discoveredRecipes:[]}},
  {id:'replace',state:{coins:2000,weapon:item('blast-rod','weapon',3,.09),armor:item('gale-cloak','armor',3,.08),healingPotions:1,inventory:[],discoveredRecipes:[]}},
  {id:'complete',state:{coins:2000,weapon:item('arcane-staff','weapon',5,.15,true),armor:item('iron-robe','armor',5,.08,true),healingPotions:3,inventory:[],discoveredRecipes:[]}},
];
