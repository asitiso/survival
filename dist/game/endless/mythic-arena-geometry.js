...
export const MYTHIC_ARENA_GEOMETRY_IDS = ['solar-ring', 'brood-pockets', 'iron-corridor', 'void-orbit', 'twin-cross', 'broken-clock'];
export function mythicArenaGeometryProfile(archetype, destroyedWeakpointRatio) {
