...
export function openingThirtyMinuteSample(elapsedSeconds) {
...
export function openingThirtyTimetableAudit() {
    ...
    maxSpawnDelta = round(maxSpawnDelta);
    maxEliteDelta = round(maxEliteDelta);
    maxRewardDelta = round(maxRewardDelta);
