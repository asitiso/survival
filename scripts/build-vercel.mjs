...
await Promise.all([
  ...
  cp(new URL("../manifest.webmanifest", import.meta.url), new URL("manifest.webmanifest", outputDirectory)),
  cp(new URL("../service-worker.js", import.meta.url), new URL("service-worker.js", outputDirectory)),
