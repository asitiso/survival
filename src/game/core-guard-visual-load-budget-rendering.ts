...
export interface CoreGuardVisualLoadBudgetInput{coreHitAlphaScale:number;projectileAccentAlpha:number;contactAccentAlpha:number;mitigationRatio:number;mixedPressure:boolean;}
export function coreGuardVisualLoadBudgetPresentation(input:CoreGuardVisualLoadBudgetInput,reducedFlash=false){
  ...
  return{coreHitAlphaScale,accentAlphaScale,combinedVisualLoad,visualLoadCap,guardOwnedBias,presentationOnly:true as const};
}
