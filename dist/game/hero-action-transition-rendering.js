...
export function advanceHeroActionTransitionState(previous, event, dt, reducedMotion = false) {
    ...
    let last = bridge > 0 ? prev.last : 'neutral';
    if (event === 'hit') {
        hit = 1;
        cast *= .72;
        evade *= .45;
...
export function heroActionTransitionPresentation(state, facingX, facingY, speed, reducedMotion = false) {
