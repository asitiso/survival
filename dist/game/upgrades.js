...
import { relicCandidates, relicDefinition } from './relics.js';
import { fusionCandidates, fusionDefinition, fusionHeroName } from './spell-fusions.js';
const SPELL_COPY = {
...
export function applyUpgrade(id, hero, spells) {
...
export function buildUpgradeChoices(hero, spells, rng = Math.random) {
    const pool = [];
