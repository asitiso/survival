...
export function coreGuardMixedSourceCompositionPresentation(input, reducedFlash = false) {
    ...
    return { mixed, bodyScaleX, bodyScaleY, projectileAccentAlpha, contactAccentAlpha, damageOwner: input.owner, duplicatesDamageCue: false, presentationOnly: true };
}
