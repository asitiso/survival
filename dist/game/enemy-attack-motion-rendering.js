...
const RANGED = new Set(['archer', 'shaman', 'nullifier']);
export function enemyAttackMotionPresentation(type, attackTimer, attackInterval, targetDx, targetDy, inRange, reducedMotion = false) {
