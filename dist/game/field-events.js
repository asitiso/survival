export const FIELD_EVENT_SPECS = {
    goldenGoblin: {
...
export class FieldEventDirector {
    rng;
    active = null;
    nextAt = FIRST_EVENT_AT;
    lastEventId = null;
    constructor(rng = Math.random) {
        this.rng = rng;
    }
    get nextEventAt() { return this.nextAt; }
    reset() {
        this.active = null;
