...
export interface AscensionMutatorRuntimeModifiers {
  projectileSpeedMultiplier: number;
  eliteHealthMultiplier: number;
  shopIntervalMultiplier: number;
  volatileDeath: { enabled:boolean; radius:number; damage:number };
}

export function ascensionMutatorRuntimeModifiers(mutators: readonly AscensionMutator[]): AscensionMutatorRuntimeModifiers {
