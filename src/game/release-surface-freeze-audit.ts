...
const SPELL_IDS=['fireBolt','chainLightning','frostNova','flameField','meteorStorm','blackHole'] as const;
const FROZEN_HERO_IDS=['arkan','seria','kain','edric'] as const;
export interface ReleaseSurfaceFreezeAudit{actionCount:number;heroCount:number;heroIds:string[];spellCount:number;mapCount:number;snapshotSchemaVersion:1;snapshotSchemaMutation:false;passed:boolean;}
export function auditReleaseSurfaceFreeze():ReleaseSurfaceFreezeAudit{
