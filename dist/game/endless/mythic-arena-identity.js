...
function safeRatio(value) { return clamp(Number.isFinite(value) ? value : 0, 0, 1); }
export function mythicArenaIdentityProfile(archetype, base, destroyedWeakpointRatio) {
