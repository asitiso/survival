...
export interface MythicTacticLinkFeedback {
...
type Preset=Omit<MythicTacticLinkFeedback,'archetype'>;
const P:Record<BossArchetype,Preset>={
...
export function mythicTacticLinkFeedback(archetype:BossArchetype):MythicTacticLinkFeedback{
  const p=P[archetype];
  return{
